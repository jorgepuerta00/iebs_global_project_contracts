...
export type NFTsPurchasedPackageEvent = TypedEvent<
  [string, BigNumber, BigNumber] & {
    buyer: string;
    numberOfNFTs: BigNumber;
...
export class AvatarMarketplace extends BaseContract {
  ...
  filters: {
    ...
    "NFTsPurchasedPackage(address,uint256,uint256)"(
      buyer?: string | null,
      numberOfNFTs?: null,
      totalAmount?: null
    ): TypedEventFilter<
      [string, BigNumber, BigNumber],
      { buyer: string; numberOfNFTs: BigNumber; totalAmount: BigNumber }
    >;

    NFTsPurchasedPackage(
      buyer?: string | null,
      numberOfNFTs?: null,
      totalAmount?: null
    ): TypedEventFilter<
