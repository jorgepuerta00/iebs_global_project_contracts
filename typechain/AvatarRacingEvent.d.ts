...
interface AvatarRacingEventInterface extends ethers.utils.Interface {
  functions: {
...
export class AvatarRacingEvent extends BaseContract {
  ...
  interface: AvatarRacingEventInterface;
  ...
  filters: {
    "HorseEnteredRace(uint256,address,uint256)"(
      ...
      [BigNumber, string, BigNumber],
      { raceId: BigNumber; horseOwner: string; nftId: BigNumber }
    >;
